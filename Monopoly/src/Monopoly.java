...
public class Monopoly extends JPanel {
    ...
    public void createSquare(Board board) {
        ...
        City Seoul = new City("Seoul", 7, 62000, 0, 60000);
        board.getSquares().add(Seoul);
        City Busan = new City("Busan", 8, 65000, 0, 60000);
        board.getSquares().add(Busan);
        City Incheon = new City("Incheon", 9, 70000, 0, 60000);
        ...
        City Cairo = new City("Cairo", 17, 130000, 0, 80000);
        board.getSquares().add(Cairo);
        City Nairobi = new City("Nairobi", 18, 140000, 0, 80000);
        board.getSquares().add(Nairobi);
        City Marrakech = new City("Marrakech", 19, 150000, 0, 80000);
        ...
        City Paris = new City("Paris", 22, 170000, 0, 90000);
        board.getSquares().add(Paris);
        City London = new City("London", 23, 185000, 0, 90000);
        board.getSquares().add(London);
        City Rome = new City("Rome", 24, 200000, 0, 90000);
        board.getSquares().add(Rome);
        City Barcelona = new City("Barcelona", 25, 215000, 0, 90000);
        board.getSquares().add(Barcelona);
        Card chance3 = new Card("Chance", 26);
        board.getSquares().add(chance3);
        City Berlin = new City("Berlin", 27, 230000, 0, 100000);
        board.getSquares().add(Berlin);
        City Amsterdam = new City("Amsterdam", 28, 245000, 0, 100000);
        board.getSquares().add(Amsterdam);
        City Venice = new City("Venice", 29, 260000, 0, 100000);
        ...
        City Shenzhen = new City("Shenzhen", 33, 270000, 0, 110000);
        board.getSquares().add(Shenzhen);
        City Guangzhou = new City("Guangzhou", 34, 290000, 0, 110000);
        board.getSquares().add(Guangzhou);
        City Shanghai = new City("Shanghai", 35, 310000, 0, 110000);
        board.getSquares().add(Shanghai);
        City Beijing = new City("Beijing", 36, 320000, 0, 110000);
        board.getSquares().add(Beijing);
        Tax tax = new Tax();
        board.getSquares().add(tax);
        City LosAngeles = new City("Los Angeles", 38, 360000, 0, 120000);
        board.getSquares().add(LosAngeles);
        City NewYork = new City("New York", 39, 360000, 0, 120000);
